...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.currentSelectedEmployee = this.employees[0];
  }
  selectEmployee(employeeId: any): void {
    const selectedIndex = this.employees.findIndex(item => item.id === employeeId);
    this.currentSelectedEmployee = this.employees[selectedIndex];
  }
}
